...
export function CloneForm({ product, form, setField }) {
  return (
    <>
      ...
      <button type="button" style={{ ...rowBtnStyle, justifyContent: "center", gap: "8px" }}>
        <span>📤</span>
        <Text variant="bodySm" fontWeight="medium">Upload face photo</Text>
      </button>

      <button type="button" style={{ ...rowBtnStyle, justifyContent: "center", gap: "8px" }}>
        <span>🎙️</span>
        <Text variant="bodySm" fontWeight="medium">Record your voice</Text>
      </button>
